...
public class RacunPNPType : EntityBase<RacunPNPType>
{
    ...
    [EditorBrowsable(EditorBrowsableState.Never)]
    private string _promjeniNacinPlacanja;
/*
    [EditorBrowsable(EditorBrowsableState.Never)]
    private PrateciDokumentType _prateciDokument;
*/
    public string Oib
    {
        get
    ...
    public string PromijenjeniNacinPlac
    {
        get
        {
            return _promjeniNacinPlacanja;
        }
        set
        {
            _promjeniNacinPlacanja = value;
        }
    }
...
/*
    public PrateciDokumentType PrateciDokument
    {
        get
        {
            return _prateciDokument;
        }
        set
        {
            _prateciDokument = value;
        }
    }
*/
    public RacunPNPType()
    {
        ...
        //_prateciDokument = new PrateciDokumentType();
    }
}
